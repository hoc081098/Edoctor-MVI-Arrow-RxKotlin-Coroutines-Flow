...
class ServiceDetailFragment : BaseFragment(R.layout.fragment_service_detail) {
  private val binding by viewBinding<FragmentServiceDetailBinding> {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    binding.buttonOrder.setOnClickListener {
      ServiceDetailFragmentDirections
        .actionServiceDetailFragmentToCreateOrderFragment(service)
